  ...
  return (
    <div id="wd-h-tag">
      ...
      <div id="wd-your-heading">
        <h4>Elaine</h4>
        Computer science student at Northeastern who{" "} 
        <span id="wd-your-span">fences</span> in the club team and does dance.
      </div>

      <div id="wd-ai-headings">
        <h4>Lab notes</h4>
        This section collects short notes about the exercises in this lab.
        <h5>What I built</h5>
        A small page that demonstrates the six HTML heading levels.
        <h6>Next step</h6>
        Add lists and tables to the same page in the next exercise.
      </div>
    </div>
  );
}